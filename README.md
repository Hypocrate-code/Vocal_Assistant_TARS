# Voice_Assistant_TARS ![Tars_logo](https://github.com/Hypocrate-code/Voice_Assistant_TARS/blob/main/sources/local_web_server_for_config/static/assets/icon.svg)
